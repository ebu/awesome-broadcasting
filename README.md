...
* [CPA Authorization Provider](https://github.com/ebu/cpa-auth-provider) - Reference implementation for linking media devices with online identfies ([related repos](https://tech.ebu.ch/code/cpa) here).
